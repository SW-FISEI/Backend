...
@Module({
  imports: [TypeOrmModule.forFeature([DetalleHorario]), CarrerasModule, SemestresModule, MateriasModule, ParalelosModule, DetalleMateriasModule, PeriodosModule, HorariosModule, AulasModule, TitulosModule, DocentesModule],
  controllers: [DetalleHorariosController],
  providers: [DetalleHorariosService, CarrerasService, SemestresService, MateriasService, ParalelosService, DetalleMateriasService, HorariosService, AulasService, TitulosService, DocentesService],
